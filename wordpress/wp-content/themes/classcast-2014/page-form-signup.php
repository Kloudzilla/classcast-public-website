      ...
      <div class="w-container cc-content-container cc-form-content">
        <div class="w-row">
          <div class="w-col w-col-6 cc-form-col">
            <div class="cc-form-title">Lets harness mobile content</div>
            <div class="cc-form-text">This is some text, that needs to be filled with content before I can merge this feature into the dev build.&nbsp;</div>
